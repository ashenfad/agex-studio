...
>
    <div class="session-title">
        ...
        {#if s.starred}
            ...
            <svg class="star-glyph" width="12" height="12" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-label="Kept app">
