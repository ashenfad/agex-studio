...
token = google_token()
if not token:
    task_fail("Please connect your Google account in the Settings drawer.")
...
> **`google_token()` and `local_timezone()`** are registered globals — call
> them directly, do not import them.
